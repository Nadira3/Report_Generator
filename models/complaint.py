...
class Complaint(BaseModel):
    ...
    def pc_history(self):
        ...
        direct_questions = {
                ...
                'reproduction_f': ['Dyspareunia', 'menarche', 'menopause', 'Frequency', 'Quantity', 'duration_of_menstruation', 'Vaginal_discharge', 'Dysmenorrhoea', 'Previous_pregnancies', 'complication_of_previous_pregnancies', 'Prolapse', 'Urinary_incontinence', 'Breast_pain', 'Nipple_discharge', 'Lumps', 'Skin_changes', 'Swelling', 'Weight_loss', 'Vaginal_discharge', 'birth_weight'],
